...
export default function MePage() {
  ...
  return (
    <div style={{ padding: 16, maxWidth: 820 }}>
      ...
      <div><b>Created:</b> {row.created_at}</div>
      ...
      <Input label="Father's name" value={row.fathers_name ?? ""} onChange={(v) => setRow({ ...row, fathers_name: v })} />
      <Input label="Mother's name" value={row.mothers_name ?? ""} onChange={(v) => setRow({ ...row, mothers_name: v })} />
      <Input label="Date of birth" type="date" value={row.date_of_birth ?? ""} onChange={(v) => setRow({ ...row, date_of_birth: v })} />
      ...
      <Input label="My community (other)" value={row.my_community_other ?? ""} onChange={(v) => setRow({ ...row, my_community_other: v })} />
      ...
      <Input label="My occupation" value={row.my_occupation ?? ""} onChange={(v) => setRow({ ...row, my_occupation: v })} />
      <Input label="My job" value={row.my_job ?? ""} onChange={(v) => setRow({ ...row, my_job: v })} />
      <Input label="Yeshiva / seminar" value={row.yeshiva_seminar ?? ""} onChange={(v) => setRow({ ...row, yeshiva_seminar: v })} />
